        ...
        <Grid container className={classes.root}>
            ...
            <Grid item className={classes.alertMessage}>
                <Typography variant="body1">
                    Dear User, by deleting your account you are deleting all personal information. Once you have deleted
                    your account, all the information you have saved information you have saved will no longer be
                    available.
                </Typography>
            </Grid>
